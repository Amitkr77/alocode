      ...
      <main className="flex flex-col items-center w-full">
        <div className="w-full max-w-7xl px-4 md:px-10 lg:px-20 py-1 flex flex-col gap-8">
          ...
          <motion.section
            ...
            className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start px-4"
          >
            <motion.div variants={itemVariants} className="flex flex-col gap-1">
              ...
              <h2
                className="text-2xl md:text-3xl font-black leading-tight text-foreground"
                style={{ fontFamily: "'Georgia', serif" }}
              >
            ...
            <div className="flex flex-col gap-1">
              ...
              <motion.div
                ...
                whileHover="hover"
                initial="rest"
                className="flex flex-1 gap-2 rounded-2xl border p-3 flex-col group cursor-default transition-all"
                style={{
                  background: "var(--card)",
          ...
          >
            <div
              className="rounded-[2.0rem] p-4 md:p-7 flex flex-col md:flex-row items-center justify-between gap-2 relative overflow-hidden"
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h2
                  className="text-2xl md:text-3xl font-black leading-tight max-w-sm"
                  style={{
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.96 }}
                className="relative z-10 shrink-0 flex items-center gap-2 h-12 px-8 rounded-full text-base font-bold transition-colors cursor-pointer"
                style={{
